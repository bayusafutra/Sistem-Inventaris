...
@section('css-custom')
    ...
    <link href="assets/css/dashboard/home.css" rel="stylesheet" type="text/css">
    ...
    <div id="content" class="main-content">
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2025 <a target="_blank" href="https://unair.ac.id/en/">Universitas Airlangga</a>,
                    D4 Teknik Informatika.</p>
            </div>
            <div class="footer-section f-section-2">
                <p class="">Code by <a href="https://bayusafutra.my.id/" style="color: #4361ee" target="_blank">Bayu Safutra</a></p>
            </div>
        </div>
    </div>
@endsection
@section('js-custom')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (ratingCarousel) {
                new bootstrap.Carousel(ratingCarousel, {
                    interval: 3000,
                    pause: 'hover', // Opsional: pause saat hover
                });
            }
        });
    </script>
    ...
    <script src="assets/js/dashboard/custom-home.js"></script>
@endsection
