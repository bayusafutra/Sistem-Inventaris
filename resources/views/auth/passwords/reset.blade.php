...
<head>
    ...
    <title>Pemulihan Kata Sandi | TechnoLogis</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link recovery">Masukkan password baru Anda!</p>
                        <form class="text-left" method="POST" action="{{ route('reset-password.post') }}">
                            @csrf
