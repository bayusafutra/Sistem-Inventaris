                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Staff Penjualan</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="widget-one widget">
                        <div class="widget-content">
                            <div class="w-numeric-value">
                                ...
                                <div class="w-content">
                                    <span class="w-values">{{ $jumlahpenjualan }}</span>
                            ...
                            <div class="order-summary">
                                    ...
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Produk <span class="summary-count">{{ $jumlahproduk }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="summary-list summary-profit">
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Retur Konsumen<span class="summary-count">{{ $jumlahrtkonsumen }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="summary-list summary-expenses">
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Unit Produk Retur<span class="summary-count">{{ $jumlahunitrtkonsumen }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="widget-one widget">
                        <div class="widget-content">
                            <div class="w-numeric-value">
                                ...
                                <div class="w-content">
                                    <span class="w-value">{{ $jumlahexpired }}</span>
...
@section('js-custom')
    ...
    <script>
        var options4 = {
            ...
            series: [{
                name: "Restock",
                data: @json($expiredSeries), // Ganti dengan data dari controller
            }, ],
            labels: @json($expiredLabels), // Ganti dengan label dari controller
            yaxis: {
                min: 0,
            },
            grid: {
