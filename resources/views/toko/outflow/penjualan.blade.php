...
@section('js-custom')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Data dummy untuk produk dan satuan
            const dummyProducts = [{
                    name: "Beras 10Kg",
                    unit: "Karung"
                },
            ...
            function updateRekap() {
                ...
                $('#list-container .row.px-3 .selectpicker').each(function() {
                    ...
                    if (productName && productName !== '' && quantity > 0) {
                        totalProducts.add(productName); // Tambah produk unik
                        totalUnits += quantity; // Tambah jumlah satuan
                    }
                });
            ...
            $('.addProduk').off('click').one('click', function handleAddProduct() {
                ...
                try {
                    ...
                    $newSelect.on('changed.bs.select', function() {
                        ...
                        updateRekap(); // Update rekap saat produk dipilih
                    });
                    template.find('input[type="number"]').on('input', function() {
                        updateRekap(); // Update rekap saat jumlah diubah
                    });
                } catch (e) {}
            ...
            $('#add').on('shown.bs.modal', function() {
                ...
                $('#list-container').on('click', '.icon-delete button', function() {
                    ...
                    updateListNumbers();
                    updateRekap(); // Update rekap saat list dihapus
                });
            });
