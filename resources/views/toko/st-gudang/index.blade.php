                ...
                <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-chart-one">
                        <div class="widget-heading">
                            <h5 class="">Tren Inflow Produk</h5>
                        </div>
                    ...
                    <div class="widget-one widget">
                        <div class="widget-content">
                            <div class="w-numeric-value">
                                ...
                                <div class="w-content">
                                    <span class="w-values">{{ $jumlahpengadaan }}</span>
                                    <span class="w-numeric-titles">Pengadaan Restock</span>
                                </div>
                            </div>
                            <div class="w-chart">
                                <div id="grafik3"></div>
                            ...
                            <div class="order-summary">
                                    ...
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Produk <span class="summary-count">{{ $jumlahproduk }}</span>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="summary-list summary-profit">
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Retur Suplier<span
                                                        class="summary-count">{{ $jumlahrtsupplier }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="summary-list summary-expenses">
                                    <div class="summery-info">
                                        ...
                                        <div class="w-summary-details">
                                            <div class="w-summary-info">
                                                <h6>Total Unit Produk Retur<span class="summary-count">{{ $jumlahunitrtsupplier }}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="widget-one widget">
                        <div class="widget-content">
                            <div class="w-numeric-value">
                                ...
                                <div class="w-content">
                                    <span class="w-value">{{ $jumlahrestock }}</span>
                                    <span class="w-numeric-title">Restock Produk</span>
                                </div>
                            </div>
                            <div class="w-chart">
                                <div id="grafik4"></div>
                                    ...
                                    <tbody>
                                        @foreach ($produkterendah as $pt)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="td-content text-center">{{ ucwords($pt->satuan->name) }}
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
...
@section('js-custom')
    ...
    <script>
        var options3 = {
            ...
            series: [{
                name: "Pengadaan Restock",
                data: @json($pengadaanSeries),
            }, ],
            labels: @json($pengadaanLabels),
            yaxis: {
                min: 0,
            },
            grid: {
        ...
        var d_2C_4 = new ApexCharts(document.querySelector("#grafik3"), options3);
        d_2C_4.render();
    </script>
    <script>
        var options4 = {
        ...
        var d_2C_2 = new ApexCharts(document.querySelector("#grafik4"), options4);
        d_2C_2.render();
    </script>
@endsection
