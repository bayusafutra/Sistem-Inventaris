        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="master-manager" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('manager.master-satuan-produk') }}"> Satuan Produk </a>
                    </li>
                    <li>
                        <a href="{{ route('manager.master-produk') }}"> Produk </a>
                    </li>
                    <li>
                        <a href="{{ route('manager.master-staff') }}"> Staff </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="#inventaris-manager" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="#inventaris-stgudang" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-package">
                ...
                <ul class="collapse submenu list-unstyled" id="inventaris-stgudang" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('stgudang.pengadaan-restock') }}"> Pengadaan Restock </a>
                    </li>
                    <li>
                        <a href="{{ route('stgudang.restock') }}"> Restock </a>
                    </li>
                    <li>
                        <a href="{{ route('stgudang.expired') }}"> Expired </a>
                    </li>
                    <li>
                        <a href="{{ route('stgudang.retur-supplier') }}"> Retur Supplier </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                <a href="#inventaris-stpenjualan" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-package">
                ...
                <ul class="collapse submenu list-unstyled" id="inventaris-stpenjualan" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('stpenjualan.penjualan') }}"> Penjualan </a>
                    </li>
                    <li>
                        <a href="{{ route('stpenjualan.retur-konsumen') }}"> Retur Konsumen </a>
                    </li>
                </ul>
            </li>
